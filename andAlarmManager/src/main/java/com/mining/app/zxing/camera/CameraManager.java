...
//      if (width < UnitUtils.dip2px(context, MIN_FRAME_WIDTH)) {
//        width = UnitUtils.dip2px(context, MIN_FRAME_WIDTH);
//      } else if (width > UnitUtils.dip2px(context, MAX_FRAME_WIDTH)) {
//        width = UnitUtils.dip2px(context, MAX_FRAME_WIDTH);
//      }
//      int height = screenResolution.y * 3 / 4;
//      if (height < UnitUtils.dip2px(context, MIN_FRAME_HEIGHT)) {
//        height = UnitUtils.dip2px(context, MIN_FRAME_HEIGHT);
//      } else if (height > UnitUtils.dip2px(context, MAX_FRAME_HEIGHT)) {
//        height = UnitUtils.dip2px(context, MAX_FRAME_HEIGHT);
//      }
