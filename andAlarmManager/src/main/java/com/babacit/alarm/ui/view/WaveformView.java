...
public class WaveformView extends SurfaceView {
	...
	// as the amplitude
	// that reaches the top/bottom of the view instead of +/- 32767. Any samples
	// that have
	...
	public synchronized void updateAudioData(short[] buffer) {
		...
		// We want to keep a small amount of history in the view to provide a
		// nice fading effect.
