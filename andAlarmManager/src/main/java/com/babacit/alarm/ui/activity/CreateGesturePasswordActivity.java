...
import com.babacit.alarm.ui.view.LockPatternView.DisplayMode;
...
public class CreateGesturePasswordActivity extends BaseActivity implements
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.pattern_lock_gesturepassword_create);
	...
	private void updatePreviewViews() {
		...
		for (LockPatternView.Cell cell : mChosenPattern) {
			...
			mPreviewViews[cell.getRow()][cell.getColumn()]
					.setBackgroundResource(R.drawable.pattern_lock_gesture_create_grid_selected);
