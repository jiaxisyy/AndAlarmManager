...
public class HomeworkRemindActivity extends BaseActivity implements
        OnClickListener, OnMyDialogClickListener {
    private List<AlarmInfo> _alarmList = new ArrayList<AlarmInfo>();
    private AlarmInfo alarmInfo/* , alarmEndInfo */;
    ...
    private Button mBtChooseStartRing, mBtChooseEndRing, mBtRecordStartVoice,
            mBtRecordEndVoice;
    ...
    private Handler mHandler = new Handler() {
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                ...
                case 3:
                    dismissProgress();
                    ToastUtil.showToast(HomeworkRemindActivity.this,
                            ErrUtils.getErrorReasonStr(msg.arg1));
                    break;
                case 2:
                    setResult(MainActivity.RESULT_CODE_FROM_HOMEWORK_ALARM);
                    dismissProgress();
                    finish();
                    break;
                default:
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_homework_remind_alarm);
...
//		mTvAlarmDate.setText(alarmInfo.getDate());
    ...
    private void initializeAlarmInfo() {
        ...
        RingInfo ringStart = new RingInfo();
        ringStart.setRingName("嘟嘟嘟，做作业的时间到啦");
        ringStart.setRingType(1);
        ringStart.setRingCategory(3);
        ringStart.setRingId(3012);
        ringStart.setRingUrl(Constant.BASE_URL + "uploads/factory/ring/voice012.mp3");
        RingInfo ringEnd = new RingInfo();
        ringEnd.setRingName("嘟嘟嘟，作业做完了没有呀");
        ringEnd.setRingType(1);
        ringEnd.setRingCategory(3);
        ringEnd.setRingId(3011);
        ringEnd.setRingUrl(Constant.BASE_URL + "uploads/factory/ring/voice011.mp3");
        _ringList.add(ringStart);
        _ringList.add(ringEnd);
    ...
    private void bindField() {
        ...
        mTvAlarmLabel = (TextView) findViewById(R.id.tv_homework_remind_alarm_title);
        mTvAlarmCircle = (TextView) findViewById(R.id.tv_homework_remind_alarm_circle);
        mTvAlarmDate = (TextView) findViewById(R.id.tv_homework_remind_alarm_date);
        mTvAlarmEarlyTime = (TextView) findViewById(R.id.tv_homework_remind_alarm_early_time);
        mTvAlarmRemark = (TextView) findViewById(R.id.tv_homework_remind_alarm_remark);
        mTvStartTime = (TextView) findViewById(R.id.tv_homework_remind_start_time);
        mTvEndTime = (TextView) findViewById(R.id.tv_homework_remind_end_time);

        findViewById(R.id.tv_homework_remind_alarm_finish).setOnClickListener(
                this);
        findViewById(R.id.ll_homework_start_time).setOnClickListener(this);
        findViewById(R.id.ll_homework_finish_time).setOnClickListener(this);
        findViewById(R.id.btn_homework_remind_alarm_back).setOnClickListener(
                this);
        findViewById(R.id.rl_homework_remind_alarm_label).setOnClickListener(
                this);
        findViewById(R.id.rl_homework_remind_alarm_circle).setOnClickListener(
                this);
        findViewById(R.id.rl_homework_remind_alarm_date).setOnClickListener(
                this);
        findViewById(R.id.rl_homework_remind_alarm_early_time)
                .setOnClickListener(this);
        findViewById(R.id.rl_homework_remind_alarm_remark).setOnClickListener(
                this);
        mBtChooseStartRing = (Button) findViewById(R.id.btn_choose_start_ring);
        mBtChooseStartRing.setText("  铃  声  ");
        mBtChooseStartRing.setSelected(true);
        mBtChooseEndRing = (Button) findViewById(R.id.btn_choose_end_ring);
        mBtChooseEndRing.setText("  铃  声  ");
        mBtChooseEndRing.setSelected(true);
        mBtRecordStartVoice = (Button) findViewById(R.id.btn_record_start_voice);
        mBtRecordEndVoice = (Button) findViewById(R.id.btn_record_end_voice);
        mBtChooseStartRing.setOnClickListener(this);
        mBtChooseEndRing.setOnClickListener(this);
        mBtRecordStartVoice.setOnClickListener(this);
        mBtRecordEndVoice.setOnClickListener(this);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.tv_homework_remind_alarm_finish:
                if (!NetworkUtils.isNetWorkOk(getApplicationContext())) {
                    ToastUtil.showToast(getApplicationContext(), "请检查您的网络！");
                    return;
                }
                if (_ringList == null || _ringList.size() < 2) {
                    ToastUtil.showToast(getApplicationContext(), "请选择开始与结束铃声！");
                    return;
                }
                ...
                break;
            case R.id.btn_homework_remind_alarm_back:
                finish();
                break;
            case R.id.rl_homework_remind_alarm_label:
                Intent title = new Intent(HomeworkRemindActivity.this,
                ...
                break;
            case R.id.rl_homework_remind_alarm_early_time:
                ...
                pre.show(getFragmentManager(), "homework_early_time");
                break;
            case R.id.rl_homework_remind_alarm_circle:
                ...
                circle.show(getFragmentManager(), "homework_circle");
                break;
            case R.id.rl_homework_remind_alarm_date:
                DateWheelDialogFragment date = new DateWheelDialogFragment();
                date.show(getFragmentManager(), "homework_date");
                mTvAlarmDate.setText(DateUtils.getDateStringYearMonthDay());
                break;
            case R.id.ll_homework_start_time:
                TimeWheelDialogFragment startTime = new TimeWheelDialogFragment();
                startTime.show(getFragmentManager(), "homework_start");
                break;
            case R.id.ll_homework_finish_time:
                TimeWheelDialogFragment finishTime = new TimeWheelDialogFragment();
                finishTime.show(getFragmentManager(), "homework_finish");
                break;
            case R.id.btn_choose_start_ring:
                Intent startRing = new Intent(HomeworkRemindActivity.this,
                        ChooseRingActivity.class);
                startRing.putExtra("ring", _ringList.get(0));
                startActivityForResult(startRing, 1);
                break;
            case R.id.btn_choose_end_ring:
                Intent endRing = new Intent(HomeworkRemindActivity.this,
                        ChooseRingActivity.class);
                endRing.putExtra("ring", _ringList.get(1));
                startActivityForResult(endRing, 3);
                break;
            case R.id.btn_record_start_voice:
                Intent startVoice = new Intent(HomeworkRemindActivity.this,
                        RecordVoiceActivity.class);
                startActivityForResult(startVoice, 4);
                break;
            case R.id.btn_record_end_voice:
                Intent endVoice = new Intent(HomeworkRemindActivity.this,
                        RecordVoiceActivity.class);
                startActivityForResult(endVoice, 5);
                break;
            case R.id.rl_homework_remind_alarm_remark:
                Intent remark = new Intent(HomeworkRemindActivity.this,
                        CommonSettingActivity.class);
    ...
    public void onDialogConfirm(String tag, boolean cancelled,
        ...
        if (tag.equals("homework_early_time")) {
        ...
        } else if (tag.equals("homework_circle")) {
            try {
        ...
        } else if (tag.equals("homework_date")) {
            mTvAlarmDate.setText(message);
        } else if (tag.equals("homework_start")) {
            mTvStartTime.setText(message);
        } else if (tag.equals("homework_finish")) {
        ...
        switch (requestCode) {
            ...
            case 1:
                if (data != null && data.getParcelableExtra("ring") != null) {
                    _ringList.set(0, (RingInfo) data.getParcelableExtra("ring"));
                    alarmInfo.setRingList(_ringList);
                }
                break;
            case 2:
            ...
            case 3:
                if (data != null && data.getParcelableExtra("ring") != null) {
                    _ringList.set(1, (RingInfo) data.getParcelableExtra("ring"));
                    alarmInfo.setRingList(_ringList);
                }
                break;
            case 4:
                if (data != null && data.getParcelableExtra("voice") != null) {
                    _ringList.set(0, (RingInfo) data.getParcelableExtra("voice"));
                    alarmInfo.setRingList(_ringList);
                }
                break;
            case 5:
                if (data != null && data.getParcelableExtra("voice") != null) {
                    _ringList.set(1, (RingInfo) data.getParcelableExtra("voice"));
                    alarmInfo.setRingList(_ringList);
                }
                break;
            default:
