...
public class SleepSettingActivity extends BaseActivity implements
	...
	private Handler mHandler = new Handler() {
		...
		public void handleMessage(Message msg) {
			...
			case 0:
				...
				data.putExtra("sleep_duration", String.format("%s-%s",
						mTvStartTime.getText().toString(), mTvEndTime.getText()
								.toString()));
				setResult(MainActivity.RESULT_CODE_FROM_SLEEP_SETTING, data);
				dismissProgress();
				finish();
				break;
			case 1:
				ToastUtil.showToast(SleepSettingActivity.this,
	...
	private RequestCallBack updateSleepTimeCallBack = new RequestCallBack() {
		@Override
	...
	private void bindField() {
		findViewById(R.id.btn_sleep_setting_back).setOnClickListener(this);
		findViewById(R.id.tv_sleep_setting_finish).setOnClickListener(this);
		findViewById(R.id.rl_sleep_start_time).setOnClickListener(this);
		findViewById(R.id.rl_sleep_end_time).setOnClickListener(this);
		mTvStartTime = (TextView) findViewById(R.id.tv_sleep_start_time);
		mTvEndTime = (TextView) findViewById(R.id.tv_sleep_end_time);

	}

	private void initData() {
		String time = getIntent().getStringExtra("sleep");
