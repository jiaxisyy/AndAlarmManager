...
public class SingleBarChartView {
	private static int margins[] = new int[] { 70, 70, 70, 70 };
	private static String[] titles = new String[] { "已完成" };
	private List<double[]> values = new ArrayList<double[]>();
	private static int[] colors = new int[] { 0xFF00B3F9 };
	...
	public void initData(double[] first, List<String> option, String title,
			int maxValue) {
	...
	public View getBarChartView() {
		buildBarRenderer();
		setChartSettings(renderer, mTitle, "", "", 0, 6, 0, maxValue,
